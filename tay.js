...
HEAP[3027] = 1024;
HEAP[3028] = 1;
HEAP[3029] = "file-source";
HEAP[3030] = 2979;
HEAP[3032] = 8;
HEAP[3034] = 1;
HEAP[3035] = "save-input";
HEAP[3036] = 3028;
HEAP[3038] = 6;
HEAP[3039] = 2504;
HEAP[3040] = 1094;
...
var top = S[SP];
    SP = SP + 1;
    S[SP] = function () { console.log("waking up"); thread.wakeup(); resume(); };
},
    ];
...
HEAP[3104 +5] = 3592 ;
HEAP[3092 +5] = params.sp0;
HEAP[3074 +5] = 0;
HEAP[3080 +5] = 0;
HEAP[3086 +5] = 96 * 1024;
(new Thread(3592 + 5)).wakeup();
resume();
