...
: final
   ." c += `HEAP[" 'latest0 . ." +19] = " 'turnkey . ." ;\n`;" cr
   ." c += `HEAP[" 'limit . ." +19] = params.sp0;\n`;" cr
   ." c += `HEAP[" 'sp0 . ." +19] = params.sp0;\n`;" cr
   ." c += `HEAP[" 'rp0 . ." +19] = params.rp0;\n`;" cr
   ." c += `HEAP[" 'dp0 . ." +19] = 64 * 1024;\n`" cr
   ." c += `run(" 'turnkey . ." );\n`" cr
   ...
   ."     if (HEAP[i])" cr
   ."         console.log(`HEAP[${i}] = ${HEAP[i].toSource()};`);" cr
   ." }" cr
   ." console.log(c);" cr ;
